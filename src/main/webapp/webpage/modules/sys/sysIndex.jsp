...
<head>
    ...
    <title>内容分销管理平台</title>

	<%@ include file="/webpage/include/head.jsp"%>
	<script src="${ctxStatic}/common/inspinia.js?v=3.2.0"></script>
	<script src="${ctxStatic}/common/contabs.js"></script> 
    <meta name="keywords" content="内容分销平台">
    <meta name="description" content="内容分销平台">
...
<!-- 即时聊天插件 -->
<%-- <link href="${ctxStatic}/layer-v2.3/layim/layim.css" type="t ext/css" rel="stylesheet"/>
<script type="text/javascript">
