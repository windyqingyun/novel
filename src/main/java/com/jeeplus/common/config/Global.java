...
public class Global {
	 ...
	 * 下载文件的url地址
	 */
	public static final String downloadArchiveURL = Global.getConfig("web.server.url")+"/service/interface/sys/uploadFile/download";
	...
	public static String getConfig(String key) {
		...
		if (StringUtils.isNotBlank(key)) {
			...
			if (value == null){
				...
				map.put(key, StringUtils.isNotBlank(value) ? value.trim() : StringUtils.EMPTY);
			}
		}
		return value;
	}
